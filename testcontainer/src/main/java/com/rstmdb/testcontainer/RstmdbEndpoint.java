...
@EqualsAndHashCode
@ToString
public final class RstmdbEndpoint {
     ...
     */
    public RstmdbEndpoint(String host, int port, Integer metricsPort) {
    ...
    /**
     * Returns a {@link URI} using the scheme {@code rstmdb}, e.g. {@code rstmdb://localhost:7401}.
     */
    public URI uri() {
